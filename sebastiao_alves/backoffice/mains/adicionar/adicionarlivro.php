...
<body class="bg-dark bg-opacity-25 text-start mt-3 mx-auto">
    ...
    <main>
        <div class="container-md border border-black">
            <form action="novolivro.php" class="row">
                ...
                <div class="col-12 d-flex justify-content-between flex-column gap-2 p-0">
                    <div class="row">
                        ...
                        <div class="col-10">
                            ...
                            <input type="text" name="observacao" id="observacao" class="w-100" placeholder="observação">
                        </div>
                    </div>
                </div>
                <div class="col-12 p-0">
                ...
                <div class="col-12 p-0">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea type="text" name="detalhe" id="detalhe" class="w-100" required placeholder="Detalhes"></textarea>
                        </div>
                    </div>
