...
$imprensa = selectSQL("SELECT * FROM imprensa LIMIT $elementos_pagina OFFSET $ignora");

$mprod = selectSQLUnico("SELECT Count(id) as total FROM imprensa");
        ...
        <?php foreach ($imprensa as $i => $imp) : ?>
            <div class="row p-3 p-md-5 imprensa d-flex flex-column align-items-center">
                <div class="col-md-10 col-12 text-center">
                    ...
                    <div class="col-12 my-5"><img src="<?= $imp["imagem"]; ?>" alt="Conteudo Imprensa - <?= $i + 1; ?>" class="w-100 h-auto"></div>
                    <div class="col-12 p1 text-start my-4 py-3">
                        <?= $imp["texto"]; ?>
                    </div>
                </div>
                <?= ($i % 2 == 0 ? '<div class="col-12 separa-noticias"></div>' : ""); ?>
            </div>
