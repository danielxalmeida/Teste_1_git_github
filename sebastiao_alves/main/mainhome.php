<main>
    <div class="container-fluid main">
        <div class="row mb-5 d-flex justify-content-end">
            <div class="col-md-11 col-12 d-flex flex-column flex-md-row justify-content-md-around bem-vindo shadow-menu align-items-center justify-content-center">
                <div class="col-md-5 col-12 flex-grow-1 my-2  bem-vindo-imagem">
                    <img src="<?= getImagemHome(); ?>" alt="Foto Autor" class="w-100">
                </div>
                <div class="col-md-7 col-12 ps-md-4 d-flex flex-column py-5 pe-md-5">
                    <div class="t1 sobre-mim pb-2">
                        BEM-VINDO ao meu website
                    </div>
                    <div class="p1 mt-3 texto-bem-vindo">
                        <?= getTextoAbreviadoAutorHome() . "..."; ?>
                    </div>
                    <a href="autor.php" class="align-self-md-end align-self-center mt-4"><button class="saber-mais"></button></a>
                </div>
            </div>
        </div>
